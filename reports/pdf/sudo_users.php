            ...
            <html>
                ...
                <body style="margin:1px;">
                    ...
                    <div class="list_header" align="center">
                        ...
                        <h5>Registered Users Reports</h5>
                    </div>
                    <table border="1" cellspacing="0" width="98%" style="font-size:9pt">
                        <thead>
                            <tr>
                                <th style="width:100%">User Names</th>
                                <th style="width:100%">Email Address</th>
                                <th style="width:100%">Phone Number</th>
                                <th style="width:100%">Date Joines</th>
                            </tr>
                        </thead>
                        <tbody>
                            ';
                                ...
                                while ($users = mysqli_fetch_array($users_sql)) {
                                    ...
                                    '
                                        <tr>
                                            ...
                                            <td>' . date('d M Y', strtotime($users['user_date_joined'])) . '</td>
                                        </tr>
                                    ';
                                }
                            }
...
$dompdf->render();
$dompdf->stream('User Reports', array("Attachment" => 1));
