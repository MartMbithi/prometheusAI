        ...
        <!DOCTYPE html>
            <html>
                ...
                <body style="margin:1px;">
                    <div class="footer">
                        <hr>
                        <i>My Savings, Revenue & Income Reports.</i>
                    </div>
                    ...
                    <table border="1" cellspacing="0" width="98%" style="font-size:9pt">
                        ...
                        <tbody>
                            ...
                            $html .= '
                            <tr>
                                <td  colspan="3"><b>Total Net Amount: </b></td>
...
$dompdf->render();
$dompdf->stream('Revenue, Income & Savings Reports', array("Attachment" => 1));
