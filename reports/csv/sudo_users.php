...
/* Excel Column Name */
$fields = array('#', 'User Name', 'Phone Number', 'Email', 'Date Joined');
...
$query = $mysqli->query("SELECT * FROM user ORDER BY  user_date_joined DESC");
if ($query->num_rows > 0) {
    ...
    while ($row = $query->fetch_assoc()) {
        ...
        $lineData = array(
            ...
            $row['user_phone'],
            $row['user_email'],
            date('d M Y', strtotime($row['user_date_joined']))
        );
    ...
    $excelData .= 'No User Records Available...' . "\n";
}
