...
<!-- Update Modal -->
<div class="modal fade" id="update_<?php echo $savings['purchase_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="false" style="background-color: rgba(0, 0, 0, 0.5);">
